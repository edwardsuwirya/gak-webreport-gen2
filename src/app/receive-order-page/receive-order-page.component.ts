...
@Component({
    selector: 'app-receive-order-page',
    providers: [AuthenticationService, AppTokenService, ReportingService, CustomerService, ResponsibilityCenterService],
    templateUrl: './receive-order-page.component.html',
    styleUrls: ['./receive-order-page.component.css']
})
export class ReceiveOrderPageComponent implements OnInit {
    ...
    constructor(private authService:AuthenticationService, private reportingService:ReportingService, private httpUtilService:HttpUtilService) {
    }
